  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Get in touch with the Vidya Disha team. We'd love to hear from you." />
      </Helmet>
        ...
        <section className="py-12 md:py-20">
          <div className="container mx-auto px-4 max-w-5xl">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-12">
              <h1 className="text-3xl md:text-4xl font-bold font-serif mb-3">Get in Touch</h1>
                ...
                <div className="glass-card rounded-xl p-6 space-y-6">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">hello@vidyadisha.com</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center shrink-0">
